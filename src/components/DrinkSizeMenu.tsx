export const DrinkSizeMenu = () => {
  return (
    <div className="h-full basis-[85%] py-4 pr-4 bg-white flex flex-col">
      <div className="flex flex-wrap justify-around pt-4 pb-12 gap-y-6 gap-x-1 basis-2/5">
        ...
        <button className="bg-orange-200 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
        </button>
        <button className="bg-orange-200 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
      ...
      <div className="flex flex-wrap justify-around gap-y-6 gap-x-1 basis-3/5">
        <button className="bg-purple-200 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
        </button>
        <button className="bg-purple-200 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
        ...
        <button className="bg-orange-400 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
        </button>
        <button className="bg-orange-400 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
        ...
        <button className="bg-yellow-200 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
        </button>
        <button
          disabled={true}
          className="border-gray-900 rounded-lg basis-1/6"
        ></button>
        <button className="bg-green-200 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
        </button>
        <button className="bg-green-200 border-2 border-gray-900 rounded-lg basis-1/6">
          btn
